...
const breadcrumbLd = buildBlogBreadcrumbLd('Transfer Pricing for IT Services (India)', 'transfer-pricing-it-services-india')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            description="We prepare TNMM benchmarking, comparable analysis, and Form 3CEB documentation for Indian software and ITES service providers."
