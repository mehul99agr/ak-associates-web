      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section">
          <div className="container">
            ...
            description="We help startups review workforce classification, set up CLRA registration where required, and check contractor compliance before it becomes a liability."
