...
const breadcrumbLd = buildBlogBreadcrumbLd('Form 15CA/15CB NRI Remittance Guide', 'form-15ca-15cb-nri-remittance-guide')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section">
          <div className="container">
            ...
            description="We issue Form 146 (15CB) CA certificates, file Form 145 (15CA), and handle end-to-end remittance documentation for NRI clients."
          ...
          />
              ...
              <div style={{ marginTop: '3rem', padding: '1.5rem', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--text-light)', margin: 0 }}>
                  <Link href="/about#mehul-agrawal" style={{ color: 'var(--primary)', fontWeight: 700 }}>CA Mehul Agrawal</Link>, Chartered Accountant (ICAI), UAE Corporate Taxation certified. Last reviewed June 27, 2026.
                </p>
                ...
                <ul style={{ margin: 0, paddingLeft: '1.25rem', fontSize: '0.9rem' }}>
                  ...
                  <li style={{ marginBottom: 0 }}>Reserve Bank of India (FEMA / outward remittance rules); <a href="https://www.rbi.org.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary)' }}>rbi.org.in</a></li>
                </ul>
              </div>
