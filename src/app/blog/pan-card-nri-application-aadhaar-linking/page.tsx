...
const faqs: [string, string][] = [
  ['How does an NRI get a PAN card in India?', 'An NRI applies online through the Protean (NSDL) portal using Form 49A (Indian citizens) or Form 49AA (foreign citizens), submitting a passport copy, overseas address proof, and a photograph. The application does not require the applicant to be physically present in India, and the PAN card is typically issued within 15-20 working days and can be dispatched to a foreign address.'],
