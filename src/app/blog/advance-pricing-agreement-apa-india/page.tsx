...
const breadcrumbLd = buildBlogBreadcrumbLd('Advance Pricing Agreement (APA) India', 'advance-pricing-agreement-apa-india')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            description="We help assess whether an APA, safe harbour, or standard benchmarking is the right fit, and support the full application and negotiation process."
