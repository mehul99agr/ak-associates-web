          ...
          <div className="container">
            ...
            <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div className="blog-content" style={{ fontSize: '1.05rem', lineHeight: '1.85', color: 'var(--text-main)' }}>
                ...
                <ol>
                  <li><strong>Proceeds land in the NRO account:</strong> Sale consideration from an NRI seller must first be credited to their NRO (Non-Resident Ordinary) account — it cannot be remitted directly abroad.</li>
