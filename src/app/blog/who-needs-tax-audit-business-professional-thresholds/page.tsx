          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="blog-content" style={{ fontSize: '1.05rem', lineHeight: '1.85', color: 'var(--text-main)' }}>
              ...
              <ul>
                ...
                <li><strong>7.</strong> If none of the above escape valves apply and turnover exceeds the threshold: a tax audit under Section 44AB (now Section 63) is mandatory, with the accompanying audit report filing (Form 3CA/3CB and 3CD for older years; consolidated into a single Form 26 under Rule 47 for tax years from April 1, 2026 onward - see our <Link href="/blog/tax-audit-report-forms-3ca-3cb-3cd-explained" style={{ color: 'var(--primary)', fontWeight: 600 }}>full guide to these forms</Link>).</li>
              </ul>
