...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Form 13 Lower Deduction Certificate for NRIs: Process, Documents & Timeline', item: 'https://agrawalkhandelwal.com/blog/form-13-lower-deduction-certificate-nri' },
  ],
}
