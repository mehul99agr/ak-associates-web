      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            description="We prepare method-selection memoranda, benchmarking studies, and Form 3CEB documentation for Indian companies with cross-border related-party transactions."
          ...
          />
            ...
            <div style={{ marginTop: '3rem', padding: '1.5rem', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
              ...
              <ul style={{ margin: 0, paddingLeft: '1.25rem' }}>
                ...
                <li style={{ marginBottom: '0.5rem' }}><Link href="/blog/comparable-uncontrolled-price-method-cup-india" style={{ color: 'var(--primary)', fontWeight: 600 }}>CUP Method Explained</Link></li>
