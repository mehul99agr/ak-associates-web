...
const breadcrumbLd = buildBlogBreadcrumbLd('India-UAE Transfer Pricing Compliance', 'india-uae-transfer-pricing-compliance')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            description="We coordinate Indian transfer pricing documentation with UAE Corporate Tax compliance, drawing on our UAE Corporate Taxation-certified expertise."
            secondaryLabel="UAE Tax Advisory"
            secondaryHref="/uae-tax-advisory"
          />
