...
const faqs: [string, string][] = [
  ['What is the TDS rate on rent paid to an NRI landlord?', 'TDS on rent paid to an NRI landlord is 30% (plus applicable surcharge and 4% cess) under Section 393(2) (earlier Section 195). This is significantly higher than the 10% TDS under Section 194-I that applies when the landlord is a resident. The 30% is computed on the gross rent, before any deductions the NRI might be entitled to (like the 30% standard deduction or municipal taxes).'],
  ['Does the tenant need a TAN to deduct TDS on rent to NRI?', 'Yes. Unlike rent to a resident landlord where TAN may not be required for individual tenants, rent to an NRI falls under Section 393(2) (earlier Section 195) which mandates TAN. The tenant must obtain a TAN via Form 49B, deduct TDS at 30% plus surcharge and cess, deposit it via Challan ITNS-281, and file Form 144 (earlier Form 27Q) quarterly.'],
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section">
          <div className="container">
            ...
            description="We handle Form 13 applications for lower TDS, Form 27Q filing for tenants, and ITR filing with TDS refund claims for NRI rental income."
