    ...
    <div className="section" style={{ background: 'var(--bg-surface)', minHeight: '100vh', paddingTop: '140px' }}>
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 60px' }}>
          ...
          <h1 style={{ fontSize: '3rem', marginBottom: '20px', color: 'var(--primary)' }}>Tax Insights & Advisory</h1>
        ...
        <div className="card" style={{ marginBottom: '60px', borderLeft: '4px solid var(--accent)' }}>
          <h2 style={{ fontSize: '1.5rem', marginBottom: '20px', color: 'var(--primary)' }}>Upcoming Compliance Deadlines (March 2026)</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
            <div style={{ background: 'var(--bg-surface)', padding: '20px', borderRadius: '8px', border: '1px solid var(--border)' }}>
              ...
              <div style={{ fontWeight: 600, color: 'var(--text-main)' }}>TDS/TCS Deposit</div>
            ...
            <div style={{ background: 'var(--bg-surface)', padding: '20px', borderRadius: '8px', border: '1px solid var(--border)' }}>
              ...
              <div style={{ fontWeight: 600, color: 'var(--text-main)' }}>GSTR-1 Filing</div>
            ...
            <div style={{ background: 'var(--bg-surface)', padding: '20px', borderRadius: '8px', border: '1px solid var(--border)' }}>
              ...
              <div style={{ fontWeight: 600, color: 'var(--text-main)' }}>Advance Tax</div>
            ...
            <div style={{ background: 'var(--bg-surface)', padding: '20px', borderRadius: '8px', border: '1px solid var(--border)' }}>
              ...
              <div style={{ fontWeight: 600, color: 'var(--text-main)' }}>GSTR-3B Filing</div>
          ...
          {posts.map((post, i) => (
            <div key={i} className="card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                ...
                <h2 style={{ fontSize: '1.6rem', marginBottom: '15px', lineHeight: 1.3, color: 'var(--primary)' }}>{post.title}</h2>
                <p style={{ color: 'var(--text-light)', marginBottom: '30px' }}>{post.summary}</p>
              </div>
              <Link href={`/blog/${post.slug}`} style={{ borderTop: '1px solid var(--border)', paddingTop: '20px', color: 'var(--accent)', fontWeight: 700 }}>
        ...
        <div className="cta-section" style={{ background: 'var(--primary)', color: '#fff', textAlign: 'center', marginTop: '100px', borderRadius: 'var(--radius-lg)', padding: '4rem 2rem' }}>
          <h2 style={{ color: '#fff' }}>Don't Miss a Single Update.</h2>
          <p style={{ color: '#e2e8f0', marginBottom: '40px' }}>Join 500+ professionals receiving our monthly regulatory digest.</p>
          <div style={{ display: 'flex', gap: '15px', justifyContent: 'center', maxWidth: '500px', margin: '0 auto', flexWrap: 'wrap' }}>
            <input type="email" placeholder="Your Email Address" style={{ padding: '14px', borderRadius: '4px', border: 'none', flex: 1, minWidth: '200px', background: '#fff', color: '#000' }} />
            <button className="btn" style={{ background: 'var(--accent)', color: '#fff', fontWeight: 700 }}>Subscribe</button>
          </div>
        </div>
      </div>
    </div>
