...
const breadcrumbLd = buildBlogBreadcrumbLd('NRI Residential Status Rules (FY 2026-27)', 'nri-residential-status-182-day-rule')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section">
          <div className="container">
            ...
            description="We calculate residential status for NRIs, determine RNOR eligibility, and advise on the tax implications of status changes. Get it right before you file."
          ...
          />
              ...
              <div style={{ marginTop: '3rem', padding: '1.5rem', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--text-light)', margin: 0 }}>
                  <Link href="/about#mehul-agrawal" style={{ color: 'var(--primary)', fontWeight: 700 }}>CA Mehul Agrawal</Link>, Chartered Accountant (ICAI), UAE Corporate Taxation certified. Last reviewed May 15, 2026.
                </p>
