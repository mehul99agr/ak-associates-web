...
const breadcrumbLd = buildBlogBreadcrumbLd('Company Name Reservation Guide (India)', 'company-name-reservation-run-form-india')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            description="We handle name reservation, SPICe+ filing, and the full incorporation process end to end."
