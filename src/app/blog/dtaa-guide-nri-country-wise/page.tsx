          ...
          <div className="container">
            ...
            <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', color: 'var(--text-light)', marginBottom: '2.5rem', fontSize: '0.9rem', fontWeight: 600, flexWrap: 'wrap', alignItems: 'center' }}>
                <span>Published August 11, 2026</span><span aria-hidden>&bull;</span><Link href="/about#mehul-agrawal" style={{ color: 'var(--primary)', fontWeight: 700 }}>CA Mehul Agrawal</Link><span aria-hidden>&bull;</span><span>Agrawal Khandelwal &amp; Associates LLP</span>
              </div>
            ...
            description="We advise NRIs on treaty rate optimisation, TRC procurement, Form 10F filing, and Form 67 foreign tax credit claims."
          ...
          />
              ...
              <div style={{ marginTop: '3rem', padding: '1.5rem', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--text-light)', margin: 0 }}>
                  <Link href="/about#mehul-agrawal" style={{ color: 'var(--primary)', fontWeight: 700 }}>CA Mehul Agrawal</Link>, Chartered Accountant (ICAI), UAE Corporate Taxation certified. Last reviewed August 11, 2026.
                </p>
              ...
              <div style={{ marginTop: '1.5rem', padding: '1.5rem', background: 'var(--bg-main)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
                ...
                <ul style={{ margin: 0, paddingLeft: '1.25rem' }}>
                  ...
                  <li style={{ marginBottom: '0.5rem' }}><Link href="/blog/navigating-international-taxation-dtaa" style={{ color: 'var(--primary)', fontWeight: 600 }}>Navigating International Taxation & DTAA</Link></li>
