...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'NRI Capital Gains on Inherited Property', item: 'https://agrawalkhandelwal.com/blog/nri-capital-gains-inherited-gifted-property' },
  ],
}
