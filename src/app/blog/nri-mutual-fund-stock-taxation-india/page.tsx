...
const faqs: [string, string][] = [
  ['How are mutual funds taxed for NRIs in India?', 'NRI mutual fund gains are taxed by holding period and fund type: equity fund LTCG (holding over 1 year) at 12.5% above a Rs 1.25 lakh annual exemption, equity fund STCG at 20%, and debt fund gains at 20% LTCG or slab-rate STCG (typically 30% for NRIs), all subject to surcharge and 4% cess. TDS is deducted by the AMC at redemption, and any excess can be reclaimed by filing an Indian ITR.'],
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section">
          <div className="container">
            ...
            description="We advise NRIs on mutual fund and stock taxation, TDS refund claims, PIS compliance, and DTAA credit optimisation."
