...
const breadcrumbLd = buildBlogBreadcrumbLd('Safe Harbour Rules India (2026)', 'safe-harbour-rules-transfer-pricing-india')
        ...
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="blog-content" style={{ fontSize: '1.05rem', lineHeight: '1.85', color: 'var(--text-main)' }}>
              ...
              <p>Safe harbour is often worth evaluating for a routine captive entity where the group values certainty and the business model is stable; particularly where the Indian entity is a limited-risk software development or ITES service provider on a straightforward cost-plus arrangement, where historical benchmarking has produced volatile results because of comparable-company disputes, and where the group prefers lower <Link href="/blog/transfer-pricing-audit-assessment-india" style={{ color: 'var(--primary)', fontWeight: 600 }}>transfer pricing audit</Link> uncertainty over marginal tax savings.</p>
            ...
            description="We model the safe harbour outcome against a full benchmarking study so you can make an informed election before filing Form 3CEFA."
