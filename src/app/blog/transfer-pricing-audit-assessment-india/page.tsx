...
const breadcrumbLd = buildBlogBreadcrumbLd('TP Audit & Assessment in India', 'transfer-pricing-audit-assessment-india')
...
const faqs: [string, string][] = [
  ['What does a TP audit mean?', 'A TP audit (transfer pricing audit) means a Transfer Pricing Officer examines a company\'s international or specified domestic transactions with related parties to check whether the price or margin reported is at arm\'s length. It goes beyond checking the Form 3CEB filing; the TPO can review the intercompany agreement, functional profile, cost-base calculation, comparable selection, and business rationale before proposing any adjustment.'],
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <PostCTA
            heading="Facing a TP audit or notice from the TPO?"
            description="We handle TPO submissions, show-cause responses, DRP objections, and MAP coordination for Indian subsidiaries and JVs under assessment."
