...
const breadcrumbLd = buildBlogBreadcrumbLd('NRI Returning to India Checklist (2026)', 'nri-returning-india-financial-checklist')
      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section">
          <div className="container">
              ...
              <div className="blog-content" style={{ fontSize: '1.05rem', lineHeight: '1.85', color: 'var(--text-main)' }}>
                ...
                <div style={{ overflowX: 'auto' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '2rem', fontSize: '0.95rem' }}>
                    <thead>
                      <tr>
                        <th style={{ background: 'var(--primary)', color: 'var(--white)', padding: '0.75rem 1rem', textAlign: 'left', fontWeight: 700 }}>When</th>
                        <th style={{ background: 'var(--primary)', color: 'var(--white)', padding: '0.75rem 1rem', textAlign: 'left', fontWeight: 700 }}>Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
            ...
            description="We help returning NRIs with RNOR planning, bank account conversion, investment restructuring, and the first ITR filing as a resident. Start early to maximise your tax-free window."
