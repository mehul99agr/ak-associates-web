...
const articleLd = { '@context': 'https://schema.org', '@type': 'Article', headline: 'NRI Tax Compliance Calendar: Key Dates & Deadlines (FY 2026-27)', description: 'Tax deadlines for NRIs.', datePublished: '2026-08-14', dateModified: '2026-08-14', author: { '@type': 'Person', '@id': 'https://agrawalkhandelwal.com/#mehul-agrawal', name: 'CA Mehul Agrawal' }, publisher: { '@type': 'Organization', '@id': 'https://agrawalkhandelwal.com/#organization', name: 'Agrawal Khandelwal & Associates LLP', logo: { '@type': 'ImageObject', url: 'https://agrawalkhandelwal.com/logo.png' } }, mainEntityOfPage: 'https://agrawalkhandelwal.com/blog/nri-tax-compliance-calendar-deadlines' }
