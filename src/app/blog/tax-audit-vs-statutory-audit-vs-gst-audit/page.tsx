...
const faqs: [string, string][] = [
  ...
  ['Can the same chartered accountant do the statutory audit and the tax audit?', 'Generally yes, and in practice it usually is the same firm, since the tax auditor relies heavily on the audited financial statements. The two remain legally distinct engagements with separate reports (audit report under the Companies Act vs the tax audit report under the Income Tax Act, Form 3CA/3CB plus 3CD for years before April 1, 2026, consolidated into a single Form 26 from that date onward), and a private limited company\'s statutory auditor cannot always double as tax auditor if independence or rotation rules under the Companies Act create a conflict; check with your CA on a case-by-case basis.'],
        ...
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="blog-content" style={{ fontSize: '1.05rem', lineHeight: '1.85', color: 'var(--text-main)' }}>
              ...
              <p>For tax years before April 1, 2026, the tax auditor issued Form 3CA (where the entity is already subject to audit under another law, such as a company's statutory audit) or Form 3CB (where the tax audit is the only audit being conducted), accompanied by Form 3CD, a detailed statement of prescribed particulars covering depreciation, disallowances, TDS compliance, related-party transactions, and more. From April 1, 2026, these three are consolidated into a single <strong>Form 26</strong> under Rule 47 of the Income-tax Rules 2026; see our <Link href="/blog/tax-audit-report-forms-3ca-3cb-3cd-explained" style={{ color: 'var(--primary)', fontWeight: 600 }}>dedicated guide to these forms</Link> for the full breakdown. Either way, this audit exists specifically to give the tax department a reliable, CA-certified basis for computing taxable income; it is not an opinion on the financial statements as a whole the way a statutory audit is. For the exact current turnover thresholds and which categories of taxpayers are covered, see our <Link href="/blog/tax-audit-section-44ab-turnover-limits-fy-2026-27" style={{ color: 'var(--primary)', fontWeight: 600 }}>Section 44AB turnover limits guide</Link>, and for the filing deadline and penalty exposure if it is missed, see our <Link href="/blog/tax-audit-due-date-penalty-for-delay" style={{ color: 'var(--primary)', fontWeight: 600 }}>tax audit due date and penalty guide</Link>.</p>
            ...
            description="We handle statutory audit, tax audit, and GST reconciliation together, so deadlines across all three are tracked in one place."
