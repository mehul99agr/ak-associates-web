          ...
          <div className="container">
            ...
            <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div className="blog-content" style={{ fontSize: '1.05rem', lineHeight: '1.85', color: 'var(--text-main)' }}>
                ...
                <p>If you're repatriating proceeds from a property sale specifically, the process and forms are the same, see our detailed guide on <Link href="/blog/nri-repatriation-property-sale-proceeds" style={{ color: 'var(--primary)', fontWeight: 600 }}>repatriating NRI property sale proceeds</Link> for the full walkthrough including the USD 1 million scheme mechanics.</p>
                ...
                <ul>
                  ...
                  <li><strong>Not redesignating NRE/FCNR accounts</strong> after returning to India and becoming a resident under FEMA, continuing to hold them as non-resident accounts and continuing to claim tax-exempt interest after residency has changed.</li>
