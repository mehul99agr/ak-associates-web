...
const faqs: [string, string][] = [
  ['How can I avoid or reduce TDS on my NRO account?', 'You cannot avoid NRO TDS entirely since it applies to all NRO interest with no minimum threshold, but you can reduce it from the default 30% to your country\'s DTAA treaty rate (typically 10-15%) by submitting a Tax Residency Certificate and Form 10F to your bank before the interest is credited. If TDS was already deducted at 30%, file an Indian ITR to claim the excess back as a refund.'],
