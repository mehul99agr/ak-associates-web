      ...
      <div style={{ background: 'var(--bg-surface)', minHeight: '100dvh', paddingTop: '100px' }}>
        <div className="section"><div className="container">
          ...
          <article className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <PostCTA
            heading="Not sure which tax regime works out cheaper for you?"
            description="We run the old-regime versus new-regime comparison factoring in your actual rent, deductions, and salary structure before you file."
