  ...
  return (
    <div className="card" style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
      {step < questions.length ? (
        ...
        <div>
          <div style={{ marginBottom: '15px', color: 'var(--success)', display: 'flex', justifyContent: 'center' }}><Icon name="check" size={56} /></div>
          ...
          <p style={{ color: 'var(--text-light)', marginBottom: '30px', fontSize: '0.95rem' }}>
            {getRecommendation(answers) === 'Private Limited Company'
