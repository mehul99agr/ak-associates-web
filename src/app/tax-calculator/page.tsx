    ...
    <div className="section" style={{ background: 'var(--bg-surface)', minHeight: '100vh', paddingTop: '140px' }}>
      <div className="container">
        ...
        <div className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          {taxResult && (
            <div style={{ marginTop: '40px', padding: '30px', background: 'var(--bg-surface)', borderRadius: '12px', border: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px', paddingBottom: '15px', borderBottom: '1px solid var(--border)' }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '1.2rem', color: 'var(--text-main)' }}>₹{taxResult.tax.toLocaleString('en-IN')}</span>
              </div>
              {taxResult.rebate > 0 && (
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px', paddingBottom: '15px', borderBottom: '1px solid var(--border)', color: '#10b981' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px', paddingBottom: '15px', borderBottom: '1px solid var(--border)' }}>
                ...
                <span style={{ fontWeight: 700, color: 'var(--text-main)' }}>₹{taxResult.cess.toLocaleString('en-IN')}</span>
              </div>
          ...
          <div style={{ marginTop: '30px', padding: '20px', background: 'var(--bg-surface)', borderRadius: '8px', borderLeft: '4px solid var(--accent)' }}>
